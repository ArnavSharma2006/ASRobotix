...
export default function WaitlistPage() {
  ...
  return (
    <main className="min-h-screen bg-black">
      ...
      {/* Hero Section */}
      <section className="relative pt-24 sm:pt-32 pb-12 sm:pb-16 overflow-hidden bg-black hero-gradient">
        <InteractiveGrid containerClassName="absolute inset-0" className="opacity-30" points={40} />
        
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 sm:mb-12">
            <h1 className="text-4xl sm:text-4xl md:text-6xl font-bold mb-5 sm:mb-6 tracking-tight leading-[1.05]">
              Join the
              <br />
            ...
            <p className="text-gray-400 text-base sm:text-lg mb-8 max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div>
              ...
              <p className="text-gray-400 mb-6 sm:mb-8 text-sm leading-6 sm:text-base">
                  ...
                  <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-5 sm:space-y-6">
                    ...
                    <Accordion type="single" collapsible className="w-full">
                      <AccordionItem value="optional-info">
                        <AccordionTrigger className="rounded-lg bg-white/5 border border-white/10 px-4 py-3 text-left text-white text-sm font-medium hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 sm:text-base">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 p-5 sm:p-6 rounded-xl border border-red-500/20">
